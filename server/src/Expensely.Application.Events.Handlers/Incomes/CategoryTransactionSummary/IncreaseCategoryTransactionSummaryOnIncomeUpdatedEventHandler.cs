...
{
    /// <summary>
    /// Increases the respective category transaction summary when an <see cref="IncomeUpdatedEvent"/> is raised.
    /// </summary>
    public sealed class IncreaseCategoryTransactionSummaryOnIncomeUpdatedEventHandler : IEventHandler<IncomeUpdatedEvent>
    {
        private readonly ICategoryTransactionSummaryAggregator _categoryTransactionSummaryAggregator;

        /// <summary>
        /// Initializes a new instance of the <see cref="IncreaseCategoryTransactionSummaryOnIncomeUpdatedEventHandler"/> class.
        /// </summary>
        /// <param name="categoryTransactionSummaryAggregator">The category transaction summary aggregator.</param>
        public IncreaseCategoryTransactionSummaryOnIncomeUpdatedEventHandler(
