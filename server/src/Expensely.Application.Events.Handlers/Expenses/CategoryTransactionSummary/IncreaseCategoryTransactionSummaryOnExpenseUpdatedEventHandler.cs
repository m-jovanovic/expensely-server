...
{
    /// <summary>
    /// Increases the respective category transaction summary when an <see cref="ExpenseUpdatedEvent"/> is raised.
    /// </summary>
    public sealed class IncreaseCategoryTransactionSummaryOnExpenseUpdatedEventHandler : IEventHandler<ExpenseUpdatedEvent>
    {
        private readonly ICategoryTransactionSummaryAggregator _categoryTransactionSummaryAggregator;

        /// <summary>
        /// Initializes a new instance of the <see cref="IncreaseCategoryTransactionSummaryOnExpenseUpdatedEventHandler"/> class.
        /// </summary>
        /// <param name="categoryTransactionSummaryAggregator">The category transaction summary aggregator.</param>
        public IncreaseCategoryTransactionSummaryOnExpenseUpdatedEventHandler(
