...
{
    [DbContext(typeof(ExpenselyDbContext))]
    [Migration("20201209204536_AddMessageAndMessageConsumer")]
    partial class AddMessageAndMessageConsumer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Expensely.Messaging.Abstractions.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Expensely.Messaging.Abstractions.MessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("Expensely.Messaging.Abstractions.MessageConsumer", b =>
                {
                    b.HasOne("Expensely.Messaging.Abstractions.Message", null)
                        .WithMany()
