...
namespace Expensely.Domain.Events.Users
{
    ...
    /// </summary>
    public sealed class UserCurrencyAddedDomainEvent : IDomainEvent
    {
        /// <summary>
        ...
        internal UserCurrencyAddedDomainEvent(User user, Currency currency) => (UserId, Currency) = (user.Id, currency);
